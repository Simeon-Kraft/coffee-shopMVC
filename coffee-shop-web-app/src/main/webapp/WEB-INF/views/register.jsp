		...
		<div>
			<div class="container">
				...
				<form action="/summary" method="post">
					...
					<p>
						First Name: <br> <input name="first" required
							pattern="[A-Z][a-z]*">
					</p>
					<p>
						Last Name: <br> <input name="last" required
							pattern="[A-Z][a-z]*">
					</p>
					<p>
						Birthday: <br> <input name="birthday" type="date">
					</p>
					<p>
					...
					<p>
						Phone Number: <br> <input name="number" type="number">
					</p>
					<p>
